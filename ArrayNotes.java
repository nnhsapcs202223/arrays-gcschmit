...
public class ArrayNotes
{
    public static void createArrayOfEvens()
    {
         ...
         *      
         *  All elements in the array are intialized to their default values
         *      (e.g., 0, false, null).
         *      
    ...
    public static void createArrayOfOdds()
    {
        ...
        /*
         * ArrayIndexOutOfBoundsExpectation
         * 
         *  Arrays have a fixed length once intialized. The index specified must refer to a
         *      valid index. Otherwise, an ArrayIndexOutOfBoundsException is generated.
         */
    ...
    public static void createArrayOfCalendars()
    {
        ...
        {
            calendars[i] = new GregorianCalendar(2022, i + 1, 1);
        }
         ...
         *      (e.g., referenes to calendar objects), but we can call mutator methods
