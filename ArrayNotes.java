...
public class ArrayNotes
{
    ...
    public static void createArrayOfOdds()
    {
         ...
         * 
         *  Arrays have a fixed length once intialized. The index specified must refer
        ...
        for(int odd : odds)
        {
            // odd = odds[i] <-- done behind the scenes; i is automatically updated
    ...
    public static void createArrayOfCalendars()
    {
         ...
         *      which modify the properites of the referenced objects
