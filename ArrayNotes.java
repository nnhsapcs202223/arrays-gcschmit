...
public class ArrayNotes
{
    ...
    public static void createArrayOfOdds()
    {
         ...
         *      comma-separated values. It can be used to initialize the array. The size
        ...
        int[] moreOdds = odds;
        odds[2] = 9;
        System.out.println(moreOdds[2]);                // prints 9
        ...
        for(int odd : odds)
        {
            // odd = odds[i] <-- done behind the scenes where i is managed
    ...
    public static void createArrayofCalendars()
    {
         ...
         *      of each month.
         *      
         *  When we create an array of references of objects, each element is initialized
         *      to null. We have to explictly create *new* objects and assign the
